...
export function ExtensionDialogHost() {
	...
	return <>
		...
		{active && <div className="pd-extension-backdrop"><div ref={dialogRef} className="pd-extension-dialog" role="dialog" aria-modal="true" aria-labelledby="pd-extension-title" aria-describedby={active.message ? 'pd-extension-message' : undefined} tabIndex={-1} onKeyDown={onDialogKeyDown}>
